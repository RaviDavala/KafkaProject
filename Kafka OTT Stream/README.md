...
This folder defines all source code for the 'Kafka OTT Stream' pipeline:
...
* Take a look at the sample under "sample_users_kafka_ott_stream.py" to get familiar with the syntax.
